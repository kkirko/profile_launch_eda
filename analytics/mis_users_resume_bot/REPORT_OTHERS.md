...
|:-------------------------------------|--------:|
| other_users_total                    |     1   |
| share_all_users_%                    |     0.2 |
| other_users_with_cvEnhancedResult    |     1   |
| share_among_cvEnhancedResult_users_% |     0.2 |
| jobs_latex_present_%                 |   100   |
| jobs_talent_present_%                |   100   |
| skills_or_tools_present_%            |   100   |
| region_specified_%                   |   100   |
| seniority_specified_%                |   100   |
...
| Other/Not specified -> Engineering keywords             | Engineering/IT             |       2 |
...
| Other/Not specified -> generic remapping                | Finance/Legal/HR           |       1 |
| Other/Not specified -> generic remapping                | Product/Project Management |       1 |
...
|:--------------------------------|--------:|----------:|
| Head of Real Estate Development |       1 |       100 |
